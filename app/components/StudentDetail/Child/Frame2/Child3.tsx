...
const Child3 = () => {
    ...
    return (  
        <div className={styles.frame2__content__child3}>
            <h5 className={styles.frame2__content__child3__title}>School Expense</h5>
            <div className={styles.frame2__content__child3__container}>
                <table className={styles.frame2__content__child3__container__table}>
                    <tbody className={styles.frame2__content__child3__container__table__body}>
                        {schoolExpense.map((expense, index) => (
                            <tr className={styles.frame2__content__child3__container__table__body__row} key={index}>
                                <td className={styles.frame2__content__child3__container__table__body__row__item}>
                                    <div className={styles.frame2__content__child3__container__table__body__row__item__container1}>
                                        <div className={styles.frame2__content__child3__container__table__body__row__item__container1__icon}>
                                        ...
                                        <div className={styles.frame2__content__child3__container__table__body__row__item__container1__text}>
                                            <h6>#{expense.id}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td className={styles.frame2__content__child3__container__table__body__row__item}>
                                    <p className={styles.frame2__content__child3__container__table__body__row__item__paragraph}>{expense.date}</p>
                                </td>
                                <td className={styles.frame2__content__child3__container__table__body__row__item}>
                                    <h6>{expense.cost}</h6>
                                </td>
                                <td className={styles.frame2__content__child3__container__table__body__row__item}>
                                    {expense.status === 'completed' ? (<h6 className={styles['frame2__content__child3__container__table__body__row__item--green']}>Completed</h6>) : expense.status === 'pending' ? (<h6 className={styles['frame2__content__child3__container__table__body__row__item--grey']}>Pending</h6>) : (<h6 className={styles['frame2__content__child3__container__table__body__row__item--red']}>Cancelled</h6>)}
                                </td>
                            </tr>
                        ))}
                ...
                <div className={styles.frame2__content__child3__container__footer}>
                    <p>Showing 1-5 from 100 data</p>
                    <div className={styles.frame2__content__child3__container__footer__paginate}>
