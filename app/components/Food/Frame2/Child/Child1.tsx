...
const Child1 = () => {
    ...
    const foodlist: Food[] = [
        {name: "Beef Steak with Fried Potato", type: "Lunch", rate: "4.9", order: "1.456", interest: 26},
        {name: "Pancake with Honey", type: "Breakfast", rate: "4.7", order: "1.456", interest: 26},
        {name: "Japanese Beef Ramen", type: "Lunch", rate: "4.8", order: "1.456", interest: 26},
        {name: "Mixed Salad", type: "Snack", rate: "4.2", order: "1.456", interest: 26},
        {name: "Beef Meatball with Vegetable", type: "Snack", rate: "4.5", order: "1.456", interest: 26},
    ];

    return (  
        <table className={styles.frame2__content__menulist__table}>
            <tbody className={styles.frame2__content__menulist__table__body}>
                {foodlist.map((food, index) => (
                    <tr className={styles.frame2__content__menulist__table__body__row} key={index}>
                        <td className={styles.frame2__content__menulist__table__body__row__item}>
                            <div className={styles.frame2__content__menulist__table__body__row__item__avatar}>

                            </div>
                        </td>
                        <td className={styles.frame2__content__menulist__table__body__row__item}>
                            <div className={styles.frame2__content__menulist__table__body__row__item__container1}>
                                <div className={styles.frame2__content__menulist__table__body__row__item__container1__type}>
                                    {food.type}
                                </div>
                                <h5>{food.name}</h5>
                            </div>
                        ...
                        <td className={styles.frame2__content__menulist__table__body__row__item}>
                            <div className={styles.frame2__content__menulist__table__body__row__item__container2}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="13" viewBox="0 0 28 26" fill="none">
                        ...
                        <td className={styles.frame2__content__menulist__table__body__row__item}>
                            <div className={styles.frame2__content__menulist__table__body__row__item__container3}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="30" viewBox="0 0 62 53" fill="none">
                                ...
                                <div className={styles.frame2__content__menulist__table__body__row__item__container3__item}>
                                    <h6>{food.order}</h6>
                                    <p>Total Order</p>
                                </div>
                            </div>
                        ...
                        <td className={styles.frame2__content__menulist__table__body__row__item}>
                            <div className={styles.frame2__content__menulist__table__body__row__item__container4}>
                        ...
                        <td className={styles.frame2__content__menulist__table__body__row__item}>
                            <button className={styles.frame2__content__menulist__table__body__row__item__button}>
