...
const Child1 = () => {
    return (  
        <div className={styles.frame2__content__child1}>
            <div className={styles.frame2__content__child1__circle}>
                <div className={styles.frame2__content__child1__circle__circle1}></div>
                <div className={styles.frame2__content__child1__circle__circle2}></div>
            </div>
            <div className={styles.frame2__content__child1__container}>
                <div className={styles.frame2__content__child1__container__row1}>
                    <div className={styles.frame2__content__child1__container__row1__avatar}>
                        <div className={styles.frame2__content__child1__container__row1__avatar__item}>

                        </div>
                    
                    </div>
                    <button className={styles.frame2__content__child1__container__row1__button}>
                ...
                <div className={styles.frame2__content__child1__container__row2__col}>
                    <h3 className={styles.frame2__content__child1__container__row2__col__name}>Maria Historia</h3>
                    <h6 className={styles.frame2__content__child1__container__row2__col__role}>History Teacher</h6>
                </div>
                <div className={styles.frame2__content__child1__container__row3}>
                    <div className={styles.frame2__content__child1__container__row3__col__text}>
                        <button className={styles.frame2__content__child1__container__row3__col__button}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div className={styles.frame2__content__child1__container__row3__col}>
                        <div className={styles.frame2__content__child1__container__row3__col__text}>
                            <button className={styles.frame2__content__child1__container__row3__col__button}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div className={styles.frame2__content__child1__container__row3__col}>
                        <div className={styles.frame2__content__child1__container__row3__col__text}>
                            ...
                            <h6>Historia@mail.com</h6>
                        </div>
                    </div>
                </div>
                <div className={styles.frame2__content__child1__container__remain}>
                    <h4>About:</h4>
                    <p className={styles.frame2__content__child1__container__remain__paragraph1}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
                </div>
                <div className={styles.frame2__content__child1__container__remain}>
                    <h4>Education:</h4>
                    <div>
                        <ul style={{margin: '0'}}>
                            <li className={styles.frame2__content__child1__container__remain__subject}>
                                History Major, University Akademi Historia
                                <p className={styles.frame2__content__child1__container__remain__subject__paragraph}>2013-2017</p>
                            </li>
                            <li className={styles.frame2__content__child1__container__remain__subject}>Master of History, University Akademi Historia
                                <p className={styles.frame2__content__child1__container__remain__subject__paragraph}>2017-2020</p>
                            </li>
                        </ul>
                    </div>
                </div>
                <div className={styles.frame2__content__child1__container__remain}>
                    <h4>Expertise:</h4>
                    <p className={styles.frame2__content__child1__container__remain__paragraph1}>World History, Philosophy, Prehistoric, Culture, Ancient</p>
                </div>
            </div>
        </div>
    );
