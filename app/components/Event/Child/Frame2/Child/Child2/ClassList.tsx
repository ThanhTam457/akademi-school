...
const color = ['purple', 'orange', 'yellow', 'text'];

interface props {
    subjects: Subject[];
};

const ClassList = ({subjects}: props) : React.ReactNode => 
    subjects.map((subject, index) => {
        return (
            <div className={styles.classList__item + " " + styles[`classList__item--${color[index]}`]} key={index}>
                <div className={styles.classList__item__container}>
                    <h6 className={styles.classList__item__container__title}>{subject.name}</h6>
                    <p className={styles.classList__item__container__descrip}>{subject.descrip}</p>
                    <div className={styles.classList__item__container__body}>
                        <div className={styles.classList__item__container__body__datetime}>
                            <div className={styles.classList__item__container__body__datetime__date}>
                                ...
                                <p className={styles.classList__item__container__body__datetime__date__text}>{subject.date}</p>
                            </div>
                            <div className={styles.classList__item__container__body__datetime__time}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
                                ...
                                <p className={styles.classList__item__container__body__datetime__time__text}>{subject.time}</p>
                            </div>
                        </div>
                        <div className={styles.classList__item__container__body__icon}>
                        </div>
                    </div>
                </div>
            </div>
